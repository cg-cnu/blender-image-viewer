bl_info = {
    ...
    "description": "Simple Reference Manager",
...
class RM_Reference_Manager(bpy.types.Panel):
    """
     Resize Texutres
    """
...
def register():
    bpy.utils.register_class(RM_Reference_Manager)
    bpy.utils.register_class(RM_Prev_Image)
    bpy.utils.register_class(RM_Next_Image)


def unregister():
    bpy.utils.unregister_class(RM_Reference_Manager)
